...
def test_post_accum_score(configure_repo,
                          season_2023,
                          create_gp_for_bah,
                          create_gp_for_sau,
                          bah_event,
    ...
    team_score = rdf.all_matching_triples(repo.graph(), (
        URIRef('https://fauve.io/fantasyTeam/Clojos/EventScore/SAU-2023'), None, None))

    expected_objs = {'https://fauve.io/ontology/F1/FantasyEventScore', 'https://fauve.io/f1/grandPrix/2023/SAU', 220,
                     'https://fauve.io/fantasyTeam/Clojos'}
